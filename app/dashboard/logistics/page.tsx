    ...
    <div className="flex-1 space-y-4 p-8 pt-6">
      <div className="flex items-center justify-between">
        <h2 className="text-3xl font-bold tracking-tight">
          {t('Logistics.title', 'Logistics Workflow')}
        </h2>
        <div className="flex items-center gap-2">
          ...
          >
            {t('Logistics.backToDashboard', 'Back to Dashboard')}
          </Link>
          <LanguageSwitcher />
        </div>
      </div>
      ...
      <Card>
        <CardHeader>
          <CardTitle>{t('Logistics.cardTitle', 'Containers, Allocation, Shipping Doc')}</CardTitle>
        </CardHeader>
        <CardContent>
          <LogisticsManager />
        </CardContent>
