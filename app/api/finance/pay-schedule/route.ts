 ...
 * sorted by dueDate. The dueDate on each bill was computed from the shipment date
 * plus the relevant term days when the bill was created; this endpoint simply
 * aggregates and exposes that view.
 *
